...
# ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'taskipract.servequake.com', '158.160.176.81']
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'taskipract.hopto.org', '158.160.176.81']

# CSRF_TRUSTED_ORIGINS = ['https://taskipract.servequake.com']
CSRF_TRUSTED_ORIGINS = ['https://taskipract.hopto.org']
